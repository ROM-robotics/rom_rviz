//similar to rom_rviz, but using lines instead of spheres
...
bool displaySvcCB(rom_rviz::SimpleFloatSrvMsgRequest& request,
	rom_rviz::SimpleFloatSrvMsgResponse& response) {
    g_z_height = request.request_float32;
    ROS_INFO("rom_rviz: received request for height %f", g_z_height);
